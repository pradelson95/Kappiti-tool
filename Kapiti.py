...
try:
    ...
    def Advertencia():
        ...
        for word in words:
            ...
            print("\033[91m" + "[+] Ingresaste " + BuscarEnInternet + " para buscar en Google...\n")
            sleep(3)
    ...
    print("Si algo ha salido mal es porque tal vez usted no tiene internet o acaba de presionar una tecla")
